...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mehran/MyCocoapodsLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mehran' => 'mehrtarh1@gmail.com' }
  s.source           = { :git => 'https://github.com/mehran/MyCocoapodsLibrary.git', :tag => s.version.to_s }
